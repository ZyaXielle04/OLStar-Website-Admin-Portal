# routes/api/common/bookings/provincial_car_rental.py
...
provincial_car_rental_bp = Blueprint('provincial_car_rental', __name__)

# Constants
SERVICE_TYPE = 'provincialCarRental'
...
def get_all_provincial_bookings():
    """Fetch ALL provincial car rental bookings from pendingBooking"""
    try:
        ...
        print(f"Error fetching provincial bookings: {e}")
        return []

def get_provincial_bookings_by_status(status_filter=None):
    """Fetch provincial bookings filtered by status field"""
    try:
        pending_ref = db.reference('/pendingBooking')
        pending_data = pending_ref.get()
        ...
        print(f"Error fetching provincial bookings by status: {e}")
        return []
...
def format_booking_response(booking):
    ...
    if not destination:
        destination = booking.get('dropoffLocation', '')
    ...
    return {
        ...
        'tripType': booking.get('tripType', 'oneway'),
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/bookings', methods=['GET'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
@log_request
def get_provincial_bookings():
    """Get provincial car rental bookings with conditional GET support for polling"""
    try:
        ...
        if status == 'all':
            bookings = get_provincial_bookings_by_status()
        else:
            bookings = get_provincial_bookings_by_status(status)
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/bookings/counts', methods=['GET'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
@cached(timeout=60)
def get_provincial_counts():
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/bookings/<booking_id>', methods=['GET'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
@cached(timeout=60)
def get_provincial_booking(booking_id):
    ...
    try:
        ...
        if booking.get('bookingType') != SERVICE_TYPE:
            return jsonify({'success': False, 'message': 'Not a provincial car rental booking'}), 400
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/bookings/<booking_id>/assign', methods=['POST'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
def assign_driver_to_provincial_booking(booking_id):
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/bookings/<booking_id>/color', methods=['PATCH'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
def update_provincial_booking_color(booking_id):
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/bookings/<booking_id>/complete', methods=['POST'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
def complete_provincial_booking(booking_id):
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/bookings/<booking_id>/cancel', methods=['POST'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
def cancel_provincial_booking(booking_id):
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/bookings/<booking_id>/reassign', methods=['POST'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
def reassign_provincial_booking(booking_id):
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/drivers/available', methods=['GET'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
@cached(timeout=60)
def get_available_drivers_provincial():
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/vehicles/available', methods=['GET'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
@cached(timeout=60)
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/last-updated', methods=['GET'])
@login_required_api
@role_required_api(['superadmin', 'admin'])
def get_last_updated_provincial():
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/health', methods=['GET'])
def health_check_provincial():
...
@provincial_car_rental_bp.route('/common/provincial-car-rental/cache/clear', methods=['POST'])
@login_required_api
@role_required_api(['superadmin'])
def clear_cache_provincial():
    try:
        invalidate_cache()
