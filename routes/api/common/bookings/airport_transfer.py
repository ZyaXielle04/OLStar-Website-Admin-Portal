...
def format_booking_response(booking):
    ...
    return {
        ...
        'whatsappNumber': booking.get('whatsappNumber', ''),
        'email': booking.get('email', 'N/A'),
        'amount': float(booking.get('amount', 0)),
        'paidCurrency': booking.get('paidCurrency', 'PHP'),
        ...
        'flightNumber': booking.get('flightNumber') or booking.get('flight_number', ''),
        'flight_number': booking.get('flight_number') or booking.get('flightNumber', 'N/A'),
