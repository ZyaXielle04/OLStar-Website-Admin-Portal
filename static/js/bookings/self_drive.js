...
async function setBookingCardColor(bookingId, color) {
    ...
    try {
        const response = await apiRequest(`/api/common/self-drive/bookings/${bookingId}/color`, {
            method: 'PATCH',
    ...
    return `
        <div class="booking-card booking-card-color-${cardColor}" data-booking-id="${booking.id}">
            <div class="card-header-section">
                ...
                <div class="card-badges">${status}${payment}${renderColorPicker(booking.id, cardColor)}</div>
            </div>
            <div class="card-body">
                <div class="info-row">
