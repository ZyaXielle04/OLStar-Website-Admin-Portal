...
async function loadDrivers(bookingId = null) {
    try {
        ...
        enhanceSearchableSelect(driverSelect, 'Search driver...');
    } catch (error) {
...
async function loadDriversForReassign(bookingId = null) {
    try {
        ...
        enhanceSearchableSelect(reassignDriverSelect, 'Search driver...');
    } catch (error) {
...
async function loadVehiclesForReassign(bookingId = null) {
    try {
        ...
        enhanceSearchableSelect(reassignVehicleSelect, 'Search vehicle...');
    } catch (error) {
